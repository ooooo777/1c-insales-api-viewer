...
На сайте заказ один, а в 1С пришёл другой: без характеристики товара или без доставки. Прежде чем
чинить обмен, полезно увидеть, что магазин отдаёт на самом деле. Обработка забирает заказы InSales
за период по API и показывает их в 1С: состав с идентификаторами товара и варианта, покупателя,
доставку, оплату и ответ магазина целиком. Документов, справочников и регистров в базе не создаёт
